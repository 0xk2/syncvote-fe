...
const AddNewDrawer = ({
  addNewDrawerVisibility, setAddNewDrawerVisibility, addIdentity,
} : {
  ...
  return (
    ...
    >
      <Space direction="vertical" size="small" className="w-full">
        <div className="text-sm">Identity can be an address, a gmail or twitter account</div>
        <Input
