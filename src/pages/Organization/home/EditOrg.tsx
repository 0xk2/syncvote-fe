...
const EditOrg = ({
  ...
  return (
    <Drawer open={isOpen} onClose={() => onClose()} title="Edit Organization" size="large">
      <Space direction="vertical" size="large" className="w-full">
        ...
        <Space direction="vertical" size="small" className="w-full">
          ...
          <Input.TextArea value={orgDesc} onChange={(e) => setOrgDesc(e.target.value)} />
        </Space>
        <Space direction="vertical" size="small" className="w-full">
      ...
      <InviteMember orgId={orgId} visible={shouldShowInviteMember} setVisible={setShouldShowInviteMember} />
    </Drawer>
  );
};
